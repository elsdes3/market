...
def plot_repeated_column_grouped_bar_chart(
    data: pd.DataFrame,
    xvar: str,
    yvar: str,
    color_by_col: str,
    ...
    axis_title_fontsize: int = 12,
    show_title=True,
    fig_size: Dict[str, int] = dict(width=175, height=275),
) -> None:
    """Plot repeated column grouped bar chart."""
    ptitle = (
        alt.TitleParams(
            ptitle_str,
            anchor="start",
    ...
    chart = (
        ...
        .encode(
            x=alt.X(
                ...
                title=None,
                axis=alt.Axis(
                    labelAngle=0, labels=False, ticks=False, domain=False
                ),
            ),
            y=alt.Y(
                f"{yvar}:Q",
...
def plot_repeated_column_row_grouped_bar_chart(
    data: pd.DataFrame,
    xvar: str,
    yvar: str,
    color_by_col: str,
    ...
    tooltip: List[alt.Tooltip],
    row_spacing: int = 25,
    bar_order: List[str] = ["true", "pred"],
    bar_colors: List[str] = ["lightgrey", "#cc1e1f"],
    axis_label_fontsize: int = 12,
    axis_title_fontsize: int = 12,
    show_title=True,
    fig_size: Dict[str, int] = dict(width=175, height=275),
    ...
    chart = (
        ...
        .encode(
            ...
            row=alt.Row(
                ...
                spacing=row_spacing,
                header=alt.Header(
                    labelFontSize=axis_label_fontsize, labelColor="#636363"
                ),
            ),
            column=alt.Column(
                f"{col_var}:N",
...
def plot_repeated_column_grouped_bar_chart_untidy_data(
    data: pd.DataFrame,
    xvar: str,
    yvar: str,
    color_by_col: str,
    ...
    title_dict: Dict[str, Dict[str, str]],
    tooltip: List[alt.Tooltip],
    bar_order: List[str] = ["High", "Medium", "Low"],
    bar_colors: List[str] = ["#b21218", "#ec3f2f", "#fc8767"],
    column_header_fontsize: int = 14,
    axis_label_fontsize: int = 12,
    ...
    chart = (
        ...
        .encode(
            ...
            y=alt.Y(
                f"{yvar}:Q",
                title=title_dict[yvar]["y"],
                axis=alt.Axis(
                    titleFontWeight="normal", ticks=False, domain=False
                ),
            ),
            color=alt.Color(
                color_by_col,
                scale=alt.Scale(domain=bar_order, range=bar_colors),
                title=None,
                legend=(
            ...
            column=alt.Column(
                ...
                header=alt.Header(
                    titleOrient="bottom",
                    labelOrient="bottom",
                    labelFontSize=column_header_fontsize,
                    labelColor="#636363",
                ),
                spacing=5,
            ),
